...
| `api/` | ✅ Complete | Platform API — Go + Chi router, structured logging, graceful shutdown. Endpoints: scaffold (#51), Argo CD apps (#42, #43), compliance (#48), infra list/query/create (#44, #45, #46). GitOps Claim creation with three-layer validation. RBAC configured. Secrets via ESO. |
