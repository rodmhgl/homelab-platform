...
| `cli/` | 🔨 In Progress | `rdp` CLI — Root command, config management (init/view/set), version, `status` (#66), `infra list/status` (#68), and `apps list/status/sync` (#67) complete. Next: interactive create/delete commands (#69-#71), compliance/secrets/investigate/ask commands. |
