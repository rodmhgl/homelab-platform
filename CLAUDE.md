...
| `cli/` | 🔨 rdp CLI (Go + Cobra) — Root command, config management, version, `rdp status` (#66), `rdp infra list/status` (#68), `rdp apps list/status/sync` (#67) complete. Pending: interactive create/delete (#69-#71), compliance (#73), secrets (#74), investigate (#75), ask (#76). |
